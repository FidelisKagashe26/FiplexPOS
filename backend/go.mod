...
require (
	...
	github.com/getsentry/sentry-go/fiber v0.44.1 // indirect
	github.com/gofiber/contrib/v3/sentry v1.1.0 // indirect
...
require (
	...
	github.com/philhofer/fwd v1.2.0 // indirect; indi
