...
SELECT id, user_id, type, status, created_at, updated_at, gross_total, discount_amount, net_total, applied_promotion_id, payment_method_id, payment_gateway_reference, cash_received, change_due, cancellation_reason_id, cancellation_notes, payment_url, payment_token, version, tax_amount, service_charge_amount, customer_id, shop_id FROM orders
...
SELECT
    o.id, o.user_id, o.type, o.status, o.created_at, o.updated_at, o.gross_total, o.discount_amount, o.net_total, o.applied_promotion_id, o.payment_method_id, o.payment_gateway_reference, o.cash_received, o.change_due, o.cancellation_reason_id, o.cancellation_notes, o.payment_url, o.payment_token, o.version, o.tax_amount, o.service_charge_amount, o.customer_id, o.shop_id,
    COALESCE(
...
SELECT id, name, image_url, price, stock, created_at, updated_at, deleted_at, cost_price, shop_id FROM products WHERE id = $1
`
...
SELECT id, name, description, scope, discount_type, discount_value, max_discount_amount, start_date, end_date, is_active, created_at, updated_at, deleted_at, shop_id FROM promotions WHERE id = $1
`
...
SELECT id, promotion_id, rule_type, rule_value, description, created_at, updated_at FROM promotion_rules WHERE promotion_id = $1
`
...
SELECT id, promotion_id, target_type, target_id, created_at, updated_at FROM promotion_targets WHERE promotion_id = $1
`
