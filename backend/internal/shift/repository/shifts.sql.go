...
SELECT id, shift_id, user_id, amount, type, category, description, created_at, shop_id FROM cash_transactions
WHERE shift_id = $1
...
SELECT id, user_id, start_time, end_time, start_cash, expected_cash_end, actual_cash_end, status, created_at, updated_at, shop_id FROM shifts
