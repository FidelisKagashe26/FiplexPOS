...
// Source: internal/user/auth_service.go
//
// Generated by this command:
//
//	mockgen -source=internal/user/auth_service.go -destination=mocks/mock_auth_service.go -package=mocks
//
...
func (m *MockIAuthService) Login(ctx context.Context, req user.LoginRequest) (*user.LoginResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAuthService) Profile(ctx context.Context, userID uuid.UUID) (*user.ProfileResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAuthService) RefreshToken(ctx context.Context, refreshToken string) (*user.LoginResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAuthService) Register(ctx context.Context, req user.RegisterRequest) (*user.ProfileResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAuthService) UpdatePassword(ctx context.Context, userID uuid.UUID, req user.UpdatePasswordRequest) error {
	m.ctrl.T.Helper()
...
func (m *MockIAuthService) UploadAvatar(ctx context.Context, userID uuid.UUID, data []byte) (*user.ProfileResponse, error) {
	m.ctrl.T.Helper()
