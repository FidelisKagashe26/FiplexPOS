...
// Source: POS-fiplex/pkg/utils (interfaces: Manager)
//
// Generated by this command:
//
//	mockgen -package mocks -destination mocks/mock_jwt_manager.go POS-fiplex/pkg/utils Manager
//
